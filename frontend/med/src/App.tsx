...
const App: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className='h-[60px] justify-center text-2xl font-bold text-green-400 w-1 flex m-auto'>Please wait for sometime to get first answr as render takes time to start the server.</div>
